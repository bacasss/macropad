...
UPDATE: added mounting holes to PCB and Caseee:

PCB with mouthing holes:
![macropad](images/pcbupd.png)

In 3D:
![macropad](images/pcb3dupd.png)

The back of the PCB in 3D:
![macropad](images/pcb3dbackupd.png)
